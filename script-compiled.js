...
var startButton = document.getElementById("start"); //Zmieniłem z var na const
...
}); //dlaczego nie samo: stopwatch.stop?
stopwatch.display.addEventListener("click", function () {
  return stopwatch.shot();
});
